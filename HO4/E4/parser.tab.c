...
{
      13,     1,     2,     3,    16,     1,     2,     3,     8,    13,
       9,    11,    -2,    14,     5,    15
};

static const yytype_int8 yycheck[] =
{
       6,     3,     4,     5,     6,     3,     4,     5,     7,    15,
       3,     0,     0,     7,     0,    10
};
...
#line 1105 "parser.tab.c"
  ...
  case 5: /* bloque: LLAVEIZQ $@1 instrucciones LLAVEDER  */
#line 52 "parser.y"
                                                         { salir_ambito(); }
#line 1111 "parser.tab.c"
    break;

  case 8: /* instruccion: INT ID PUNTOYCOMA  */
#line 61 "parser.y"
                      { agregar_local((yyvsp[-1].str)); }
#line 1117 "parser.tab.c"
    break;

  case 9: /* instruccion: ID PUNTOYCOMA  */
#line 62 "parser.y"
                    {
